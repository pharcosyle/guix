...
dist_patch_DATA =						\
  ...
  %D%/packages/patches/apple-silicon-gnulib-tests.patch	\
  ...
  %D%/packages/patches/dbus-broker-skip-fs-test.patch     	\
  ...
  %D%/packages/patches/glibc-2.35-gcc-13-compat.patch   	\
  ...
  %D%/packages/patches/libsoup-skip-tests.patch 		\
