...
dist_patch_DATA =						\
  ...
  %D%/packages/patches/apr-util-allow-libxcrypt.patch		\
  ...
  %D%/packages/patches/fig2dev-ghostscript-10.02-fixes.patch	\
  ...
  %D%/packages/patches/font-gnu-freefont-python-3-compat.patch	\
  ...
  %D%/packages/patches/gtk-doc-skip-mkhtml-test.patch   	\
  ...
  %D%/packages/patches/mariadb-fix-ssl-test.patch       	\
  ...
  %D%/packages/patches/mrustc-fix-for-gcc-13.patch		\
  ...
  %D%/packages/patches/pyparsing-3.0.7-sre-const-deprecation.patch	\
