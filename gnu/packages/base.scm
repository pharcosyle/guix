    ...
    `(#:parallel-build? #f            ; help2man may be called too early
      ...
      #:phases (modify-phases %standard-phases
                 ...
                 (add-after 'unpack 'remove-tests
                   (lambda _
                     ;; No localtime in the build container.
                     (for-each (lambda (f)
                                 (call-with-output-file f
                                   (lambda (port)
                                     (display "int main() { return 77; }"
                                              port))))
   ...
   (source
    (origin
      ...
      (uri (string-append "mirror://gnu/binutils/binutils-"
                          version ".tar.bz2"))
      (sha256
       (base32 "0bw7y78cbvprcx5v53j77ywdgng3gzazlhisns3pa0sy55fsrjmy"))
...
(define-public glibc-2.35
  (package
    ...
    (source (origin
              ...
              (patches (search-patches "glibc-2.35-gcc-13-compat.patch"
...
(define-public tzdata
  (package
    ...
    (source (origin
             ...
             (sha256
              (base32
               "1qzzxnv059gziwjccsgdys8nba4498qg78cdgad0blnbk92k810d"))))
    (build-system gnu-build-system)
    (arguments
     (list #:tests? #f
    ...
    (inputs (list (origin
                    ...
                    (sha256
                     (base32
                      "1y0zdax8rdic93d9jlww5h92m2qxrbj1cghl3n7lanpzmna2h1w0")))))
