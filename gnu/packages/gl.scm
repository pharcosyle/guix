...
(define-public freeglut
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0lpaqfk8hcly4ryz7ahs7i23wc5pixlpfg69xn005ypv2rjlsgcw"))))
  ...
  (package
    ...
    (source
      (origin
        ...
        (sha256
         (base32
          "0382m4ryzli4f6mla1vvi00ymmb9sy6ayv9dmak5nx2sn8k688v3"))))
    (build-system meson-build-system)
    (propagated-inputs
...
(define-public mesa-utils
  (package
    ...
    (arguments
     (list
      #:configure-flags #~(list "-Dwith-system-data-files=true")))
    (home-page "https://mesa3d.org/")
