  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32
         "0j5cwc6svwf7fprri5hz7cvvx2qw8py3f1lirrdivf2mrsk8djiy"))))
    (build-system meson-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32
         "0chqlm0jfdkvv7qj91d6y458b9srlgx7v9avgxfq0d83n7hbw9bi"))))
...
(define-public libxpresent
  (package
    ...
    (source (origin
              (method url-fetch)
              (uri (string-append "mirror://xorg/individual/lib/libXpresent-"
                                  version ".tar.xz"))
              (sha256
               (base32
