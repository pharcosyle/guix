...
(define-public harfbuzz
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0yq7nxk7ka72imi09jcd1a2w6xpji30n8dw2r5myvjb4shfacdgi"))))
  ...
  (hidden-package
   (package
     ...
     (source (origin
               ...
               (sha256
                (base32
                 "0c4a9qflzi8jqvwb5q7snhgmksscmdgrzymz0gl8xdlh2xpmnnlh"))))
     (build-system meson-build-system)
     (arguments
      (list
       #:glib-or-gtk? #t              ;to wrap binaries and/or compile schemas
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1wqhj4ip0p1z9sykpyb297yvgvpc9b826ab55p9acl09w1s6qvjr"))))
    (build-system meson-build-system)
