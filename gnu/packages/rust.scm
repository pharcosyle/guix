...
(define-public rust
  (package
    ...
    (outputs (list "out" "cargo" "rust-src" "tools"))
    (arguments
     (list
      #:builder
      #~(begin
          (symlink "/gnu/store/vz7h0qlaf0pwfm5jgj25f9wl1cqymwzn-rust-1.74.1"
                   #$output)
          (symlink "/gnu/store/7bsgcabkplwc60fgy9vsnbyn29zss0bd-rust-1.74.1-cargo"
                   #$output:cargo)
          (symlink "/gnu/store/vmqx8iyh5xgi1mazzmmrq869lw7f6h7l-rust-1.74.1-rust-src"
                   #$output:rust-src)
          (symlink "/gnu/store/pqmsdxpi7yyf2clj3bqvizw1p3zkwrvy-rust-1.74.1-tools"
                   #$output:tools))))
    (synopsis #f)
    (description #f)
    (home-page #f)
