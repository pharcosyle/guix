...
(define-public librsvg
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0972wbv5siv68bh65ybr877nf7anf7smlv8dc46za9fg106dgs8q"))))
...
(define-public network-manager
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "15c9k762l1y39vspqpb3wm0c6fccb54g5h4mqxvlj6k30rp4jp76"))))
    (build-system meson-build-system)
    (outputs '("out"
...
(define-public libadwaita
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0cjzl3xwrcbsr2hx22srs4qa3yyj6hz3f0aiwygmsigaywsqcd9v"))))
    (build-system meson-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
