     ...
     (list
      ...
      #~(modify-phases %standard-phases
          ...
          (add-after 'install 'set-statdir
            ;; For some reason the value of STATDIR becomes
...
(define-public acpica
  (package
    ...
    (source (origin
              (method url-fetch)
              (uri (string-append
                    "https://downloadmirror.intel.com/819451/acpica-unix-"
                    version ".tar.gz"))
              (sha256
               (base32
                "12rkixpx8p5aczzkx63k0a9q8jagxrf9spy9a42kxz95g549k8jl"))))
    (build-system gnu-build-system)
...
(define-public audit
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0y439vs4rd7mg0hfphgrm7vmazjl38xrlng33n5w11i7pgd3rkxm"))))
    (build-system gnu-build-system)
    (arguments
