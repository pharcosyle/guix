...
(define-public linux-libre-headers-6.6.8
  (make-linux-libre-headers "6.6.8" "gnu"
                            "08n1yngalxxqzc0338igsr88qyh53gr1hnnidan99zcf25kxcs3l"))

(define-public linux-libre-headers linux-libre-headers-6.6.8)
...
(define-public kbd
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "09h9lhddgjbhrhynarhnfccynrn0jbpln26d6c57xjpcg848v7si"))
              (modules '((guix build utils)))
              (snippet
               '(begin
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1bxq452mljmkl0y3whhga86gn22y1zxyaxpgayh8rq71p10wfwj9"))))
    (build-system meson-build-system)
    (arguments
...
(define-public wireplumber-no-logind
  (let ((base wireplumber))
    (package
      (inherit base)
      (name "wireplumber-no-logind")
      (arguments
...
(define-public ell
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0slq2vsz0m7vdf3x9q4rlwp1iarz8m3jbq0ihm6vsz5bxgfhmsw6"))))
    (build-system gnu-build-system)
    (arguments
