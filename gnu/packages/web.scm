...
(define-public json-c
  (package
    ...
    (source (origin
             ...
             (sha256
              (base32
               "1rjrc6axf51psbf6j6nkgca99h7i26zcyg3gak1v4qzvb16r2l3m"))))
    ...
    (source
     (origin
       ...
       (uri (string-append "mirror://cpan/authors/id/L/LE/LEEJO/"
                           "CGI-" version ".tar.gz"))
       (sha256
        (base32 "077rcb12hzddi9hmshksn4rzibl6nlcqvh7kjryff44bp24lpvkd"))))
    (build-system perl-build-system)
    (native-inputs
  ...
  (package
    ...
    (propagated-inputs
     (list python-boto3 python-botocore python-docutils
           python-six python-pip python-virtualenv))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32
         "0wmghxl3lqvgpymrkiv27llzd3ky5qgv42ry4k72inkg2gfd8i93"))))
    (build-system gnu-build-system)
    (outputs (list "out"
                   "lib"))              ; only libnghttp2
    (native-inputs
