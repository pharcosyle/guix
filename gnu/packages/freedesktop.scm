...
(define-public shared-mime-info
  (package
    ...
    (source (origin
             ...
             (sha256
              (base32
               "1h2lnxfx4jzqs6mpqcchrcpvz46gw2222a6clzxy0l41yj8qrv75"))
...
(define-public desktop-file-utils
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0dp8zxmbgmc8vz73480c0j61d67jy5b7qh4031ibd1g3kkrpv0d0"))))
    (build-system meson-build-system)
    (native-inputs
     (list pkg-config))
    (inputs
  ...
  (package
    ...
    (source (origin
              ...
              (uri (string-append "http://user-dirs.freedesktop.org/releases/"
                                    name "-" version ".tar.gz"))
              (sha256
               (base32 "0g6z40igbcpd83df1zbncllwp2spw6szjf90fdxa7nsw97bhcvzc"))))
    (build-system gnu-build-system)
    (native-inputs
     (list gettext-minimal
           docbook-xsl
...
(define-public xdg-desktop-portal
  (package
    ...
    (arguments
     (list
      #:glib-or-gtk? #t
      ;; FIXME: Getting a bunch of failures with the message "No GSettings
      ;; schemas are installed on the system", someone plz fix.
      #:tests? #f
