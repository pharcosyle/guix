...
(define-public extra-cmake-modules
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0wil1sgxr2apwdrnvs972mdda9jscry8zk9sirvc3gl54bvhp2pz"))))
...
(define-public kquickcharts
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0f82c7r19lpjghlfk0m12kiy616idrj8cvvlca1j1vgslw8i3s1n"))))
...
(define-public karchive
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0d7c9qgakysnpcrppxkxw9rrj0d5sa4j8jsjzlkqf9bmp1afn0z9"))))
    (build-system cmake-build-system)
    (arguments
     (list #:phases #~(modify-phases %standard-phases
                        (replace 'check
...
(define-public kcalendarcore
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "04klr2cyh7cgjnwr6if29p7cd1dg9gljk6388h3lf5xi0k1w6pyc"))))
    (build-system cmake-build-system)
    (native-inputs
...
(define-public kcoreaddons
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "176r9bx1ka19lgp07mq9qrpysx36h1xvyxh8cpsxbmz5id3pz5r8"))))
    (build-system qt-build-system)
...
(define-public kdbusaddons
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1iwbsp4cwiqxw9yzhdqfdk3m06dxz9dmfravh8phmbvjqc6hlxkc"))))
    (build-system qt-build-system)
    (native-inputs
...
(define-public kdnssd
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0glpk0l7w69fn8c07ikiyn8aw4260i133j1hndq22hf63a8srna9"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules qttools))
    (inputs
  ...
  (package
    ...
    (source (origin
              ...
              (uri (string-append
                    ...
                    name "-" version ".tar.xz"))
              (sha256
               (base32 "0r5ibx5c78ds2dyhsnzkf2r5paxzbwl6liznh19l306y8bg8laqn"))))
    (build-system cmake-build-system)
    ...
    (source
     (origin
       ...
       (uri (string-append "mirror://kde/stable/frameworks/"
                           ...
                           name "-" version ".tar.xz"))
       (sha256
        (base32 "047425g6rx1ca23z3av6xwwdzgbacrfd50pmlxg534pkz9c600ai"))))
    (build-system cmake-build-system)
    (native-inputs
...
(define-public kirigami
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "18j20xq7kq8dys4gq4w3h2qrl765v1xrgn015h766jdsjsn902qf"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules qttools))
    (inputs
...
(define-public kitemmodels
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0r93k3hjz74bc9ryj0gi9ifivnjvimjy67f3cjqh663254dxlyjc"))))
    (build-system qt-build-system)
    (native-inputs
     (list extra-cmake-modules))
    (inputs (list qtdeclarative))
...
(define-public kplotting
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "12xsiwngd93xy3cwnj35f1g6mfxraqkbgdfjbrc6580wfvvrav3k"))))
    (build-system qt-build-system)
    (native-inputs
     (list extra-cmake-modules qttools))
    (arguments (list #:qtbase qtbase))
...
(define-public ksvg
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1qw4a2lch4fm3dm09y7z3zv4rxqvx59f6zsr9fx77b3l5n2v0rgy"))))
    (build-system qt-build-system)
    (native-inputs
     (list extra-cmake-modules qttools))
    (inputs
...
(define-public ksyntaxhighlighting
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0mqj7d1a9wq8c88h0cccq48n8zmhcs8s7ax176pxjm61j8ypsg7d"))))
    (build-system cmake-build-system)
    (native-inputs
...
(define-public kwayland
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1b1lrpq2d21pgdd35na5yl67gpdz2cpph6c00m00r6wfiybnkzpl"))))
    (build-system qt-build-system)
    (native-inputs
     (list extra-cmake-modules pkg-config
           ;; for wayland-scanner
...
(define-public kwidgetsaddons
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "025bdwy15bzzyhf8s48d1106lh7ib8ckxsj1nvm0ywha1zn6d1ng"))))
    (build-system qt-build-system)
    (native-inputs
     (list extra-cmake-modules qttools))
    (arguments
...
(define-public modemmanager-qt
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "06qp79g2fgpxm17qhz3kvwaasnzj4ilm1pxvb4hb9xzwbb5fw8ha"))))
    (build-system cmake-build-system)
    (native-inputs
...
(define-public networkmanager-qt
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0rwpjiwflhnml0gibjf5jjbg5lg35fggby3qbd38hphsxx8r51qm"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules dbus pkg-config))
    (inputs (list qtbase))
...
(define-public qqc2-desktop-style
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "18sdxc1q143srqpy0zsxr184fly2cjwslv3imvf3p5lvsw02ysg9"))))
    (build-system qt-build-system)
    (arguments
     (list
      #:qtbase qtbase
...
(define-public sonnet
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0djn801aajlxsdh634xd56v8knmra5961cmw5a22afjg45hb88f4"))))
    (build-system qt-build-system)
    (arguments (list #:qtbase qtbase))
    (native-inputs
     (list extra-cmake-modules pkg-config qttools))
...
(define-public kcompletion
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0qf4b1dq5z6l3kq4mcm1pb4r0d430scsf9dl563iq0lyli15z4ca"))))
    (build-system qt-build-system)
    (native-inputs
     (list extra-cmake-modules qttools))
    (inputs
...
(define-public kfilemetadata
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1528wchkmvnr23vgaq3dnv9jszm5cfab0g0cvdz03qxvk4v6nijh"))))
    (build-system cmake-build-system)
    (arguments
     (list
      #:phases
...
(define-public kimageformats
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "05xlsx8156gxhk4dyq6l6k5v96ip5vlnxmdxs4nmyzn43ij65wnr"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules pkg-config))
    (inputs
...
(define-public kjobwidgets
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "00c5m5jap784qsqb8crj13dn663kbbzpay39xqnyd1dyv4fk1wl6"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules qttools))
    (inputs
...
(define-public syndication
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1a9b1rizzf39a2snhcw4bxhqnmy2mzdxf70wj4i3zy2cz8329kmz"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules))
    (inputs
...
(define-public baloo
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1zdf9cii4mdcyk87f4imk37pgpjvfxl55pl3m86wbgnjwybrd9ar"))))
    (build-system cmake-build-system)
    (propagated-inputs
...
(define-public plasma-activities-stats
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1fyc0jzxw862m5r5c942fkj480nnsqyrq1319vlac3bvnm81h9y2"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules))
    (inputs
...
(define-public kbookmarks
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "05ahragv1x0ha49bx5g1x46mnn5h7qn3dlanacq7qbxzs5fj3g8c"))))
    (build-system cmake-build-system)
    (propagated-inputs
     (list kwidgetsaddons))
    (native-inputs
...
(define-public kcmutils
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1h5ibikdd0zzf818sp7hrmj8mgcf0ih15f4586dzr8c5xy1nq47q"))))
    (build-system cmake-build-system)
    (propagated-inputs
     (list kconfigwidgets
           kcoreaddons
...
(define-public kdeclarative
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "189n4g3q3dvn7s9fg07s5zxiw9jrd5k2q9fwy5larhmzqy2i0imd"))))
    (build-system cmake-build-system)
    (propagated-inputs
...
(define-public kdesu
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "13rrjnyffqf725jbl03nc2vfdkxfkc0jlf14gvxa9b1z85y012hf"))))
    (build-system cmake-build-system)
    (propagated-inputs
     (list kpty))
    (native-inputs
...
(define-public knewstuff
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1jj4xldsw41nn5gx9jqj8wgayqhrc1sc8psijfy1xympz44ha59n"))))
    (build-system cmake-build-system)
    (propagated-inputs
     (list attica
           kcoreaddons))
...
(define-public krunner
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1yy36hxiwrp5kxs3l6n27660vhw2a7vbpc3hvwjjvg6z6i4jqa26"))))
    (build-system qt-build-system)
    (propagated-inputs
     (list kcoreaddons))
    (native-inputs
...
(define-public kservice
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0a41h65ss0pw1cp16cnin7m514qk1k4kcgq9kih65wp37vr6q293"))))
    (build-system cmake-build-system)
    (propagated-inputs
...
(define-public ktexteditor
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0w52wyhq4qpg4py2ajw45q958r2227961s3l24bg7pggqisann3a"))))
    (build-system cmake-build-system)
    (propagated-inputs
     (list kparts
           ksyntaxhighlighting))
...
(define-public ktextwidgets
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1f5jd2djniiv09n3g9cdwdaqbhhhzpsdqi6jc3mpggrw2cr2w7ax"))))
    (build-system qt-build-system)
    (propagated-inputs
     (list ki18n sonnet))
    (native-inputs
...
(define-public ktexttemplate
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "04h458jzzshlwvgb17svmhmwmz4la0h68sjm2nq0pbvm83xxm0rs"))))
    (build-system qt-build-system)
    (native-inputs
     (list extra-cmake-modules))
    (inputs (list qtdeclarative))
...
(define-public kwallet
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0a463r308pg294mdxl0rjdzcckrsvisyhjn2wjysab6ri0fk3dg0"))))
    (build-system cmake-build-system)
    (arguments
     (list #:phases
           #~(modify-phases %standard-phases
...
(define-public kxmlgui
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1k0zqmr425l8cj99zl910v2rpach6dsnfngw20q1ab7c8q532zwr"))))
    (build-system cmake-build-system)
    (propagated-inputs
...
(define-public libplasma
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "050vbfgr706hwg5icg5qrr2wgprc7xa7xzcpvf2wbp2pzd2s3vb6"))))
    (build-system qt-build-system)
    (propagated-inputs
...
(define-public purpose
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0sph6ma9jmpygvp4yvaaig6rsxi5yv9qhqnzly084715a4k1is3y"))))
    (build-system cmake-build-system)
    (native-inputs
    ...
    (source
     (origin
       ...
       (uri (string-append "mirror://kde/stable/frameworks/"
                           ...
                           name "-" version ".tar.xz"))
       (sha256
        (base32 "0b0qjb6jwbkpfk69ywr85qh3c1m7115zjl7chp8id6gzsjvf75fq"))))
    (build-system qt-build-system)
    (native-inputs
     (list extra-cmake-modules))
    (propagated-inputs (list kcoreaddons))
